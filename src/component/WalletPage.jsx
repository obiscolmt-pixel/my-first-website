...
export default function WalletPage({ onClose }) {
  ...
  const handleFundWallet = async () => {
    ...
    if (!amount || amount < 100)
      return setError("Minimum funding amount is ₦100");
    ...
    try {
      ...
      // Open Paystack immediately after getting reference
                    ...
                    {transactions.map((tx) => (
                      ...
                      >
                        ...
                        <div className="text-right shrink-0 ml-2">
                          <p
                            className={`text-sm font-black ${tx.type === "credit" ? "text-green-600" : "text-red-500"}`}
                          >
                            {tx.type === "credit" ? "+" : "-"}₦
