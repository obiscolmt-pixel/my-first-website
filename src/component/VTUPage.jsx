        ...
        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl z-50 overflow-hidden">
          ...
          {saved.map((b, index) => (
            <div
              ...
              onClick={() => { onSelect(b); setShowDropdown(false); }}
            >
              ...
              <>
                ...
                <div>
                  <label className="text-sm font-bold text-gray-700 mb-3 block">
                    Network {detectedAirtimeNetwork && <span className="text-orange-500 font-normal text-xs ml-1">(auto-selected)</span>}
                  </label>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-5">
            {result?.success ? <SuccessCard message={result.message} transactionId={result.data?.content?.transactions?.transactionId} /> : (
              <>
                ...
                <div>
                  <label className="text-sm font-bold text-gray-700 mb-3 block">
                    Network {detectedDataNetwork && <span className="text-orange-500 font-normal text-xs ml-1">(auto-selected)</span>}
                  </label>
                  <div className="grid grid-cols-4 gap-3">
                    {DATA_NETWORKS.map(n => (
                ...
                {!dataNetwork && (
                  <div className="p-5 border-2 border-dashed border-gray-200 rounded-2xl text-center text-gray-400 text-sm">Select a network to see plans</div>
                )}
