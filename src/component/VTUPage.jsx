                ...
                {loadingPlans ? (
                  ...
                  <div className="relative">
                    <select value={selectedPlan} onChange={e => setSelectedPlan(e.target.value)} className={selectClass}>
                      ...
                      {dataPlans.map(plan => (
                        <option key={plan.variation_code} value={plan.variation_code}>{plan.name} — ₦{Number(plan.variation_amount).toLocaleString()}</option>
                      ))}
                    </select>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={verifyMeter} disabled={verifying || !disco || !meterNumber} className="bg-orange-500 text-white px-4 rounded-xl text-sm font-bold disabled:opacity-50 hover:bg-orange-600 transition-colors whitespace-nowrap">
                    {verifying ? '...' : 'Verify'}
                  </button>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={verifySmartCard} disabled={verifying || !cableProvider || !smartCard} className="bg-orange-500 text-white px-4 rounded-xl text-sm font-bold disabled:opacity-50 hover:bg-orange-600 transition-colors whitespace-nowrap">
                    {verifying ? '...' : 'Verify'}
                  </button>
                </div>
