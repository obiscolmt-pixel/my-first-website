            ...
            <div className="flex flex-col items-center justify-center h-full text-center px-2">
              ...
              <button
                onClick={() => {
                  ...
                  window.open(
                    `https://wa.me/2349049863067?text=${encodeURIComponent(message)}`,
                    "_blank",
                  );
                }}
                className="mt-2 w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold transition w-full text-sm sm:text-base"
              >
                <svg
