...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hi! 👋 Welcome to OBISCO Store! I'm your virtual assistant and business companion. I can help you shop, give business ideas, financial tips and more. How can I help you today?",
    },
  ]);
  ...
  const callAI = async (updatedMessages) => {
    const response = await fetch(
      "https://obisco-gadgets-backend.onrender.com/api/chat",
      {
        method: "POST",
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, I'm having trouble connecting right now. Please contact us on WhatsApp: +234 904 986 3067 😊",
        },
      ]);
    } finally {
      setLoading(false);
